...
public class TestEBankingApp {
    ...
    @Test
    public void testPremium() throws IOException {
        ByteArrayOutputStream outPrintStream = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outPrintStream));
        String commandFolder = "testPremium/";
    ...
    @Test
    public void testPremium2() throws IOException {
        ByteArrayOutputStream outPrintStream = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outPrintStream));
        String commandFolder = "testPremium/";
    ...
    @Test
    public void testPremium3() throws IOException {
        ByteArrayOutputStream outPrintStream = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outPrintStream));
        String commandFolder = "testPremium/";
